# vgi-sigma — dev and test targets.
#
# Usage:
...
#
# test-sql is self-contained: it points VGI_SIGMA_WORKER at the worker run as a
...
WORKER_STDIO    ?= uv run --python 3.13 sigma_worker.py
